...
from openprocurement.auctions.core.plugins.awarding.v3_1.migration import (
    migrate_awarding2_1to_awarding3_1
)
...
def from0to1(registry):
    ...
    for i in results:
        ...
        changed = migrate_awarding2_1to_awarding3_1(auction, registry.server_id, procurement_method_types)
        if not changed:
            continue
...
def from1to2(registry):
    ...
    for i in results:
        ...
        procurement_method_types = ['rubbleOther', 'rubbleFinancial']
